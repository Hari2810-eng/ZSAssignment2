...
public class DungeonGame4 {
    ...
    public static void game(int adventureX, int adventureY, int goldX, int goldY, int monsterX, int monsterY, int triggerX, int triggerY, int m, int n) {
        DungeonGame4 dungeon = new DungeonGame4(m, n);
        adventureX -= 1;
        adventureY -= 1;
        goldX -= 1;
        goldY -= 1;
    ...
    public static void main(String[] args) {
        ...
        game(adventureX, adventureY, goldX, goldY, monsterX, monsterY, triggerX, triggerY, m, n);
    }
}
